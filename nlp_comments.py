...
cp_str = 'cp -r /home/kesci/input/Comments9120 /home/kesci/work'
os.system(cp_str)
print('finish')
...
def read_comments(fname):
    ...
    random.shuffle(data)
    return data
all_data = read_comments("/home/kesci/input/Comments9120/train_shuffle.txt")
...
w2v = KeyedVectors.load_word2vec_format('/home/kesci/input/Comments9120/sgns.wiki.word')
